      ...
      <q-card-section>
        ...
        <q-item>
          <q-item-section>
            ...
            <div class="row wrap">
              <q-checkbox
                v-model="packing.apply"
                v-for="packing in selected_packings"
                :key="packing.size"
                @input="applyFilter"
              >
                {{ packing.size }} {{ packing.unit_name }}
              </q-checkbox>
            </div>
          </q-item-section>
        </q-item>
        ...
        <q-item>
          ...
          <q-item-section>
            Offer
            <div class="row wrap">
              <div v-for="(offer, index) in selected_offers" :key="index">
                <q-toggle
                  v-model="offer.apply"
                  :label="offer.name"
                  :val="offer.name"
